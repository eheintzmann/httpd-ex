...
/** @type {Element} */
var hot2Element = document.getElementById('hot2');
...
var hot2Settings = {
  ...
  stretchH: 'all',
  width: function () {
    var positionInfo = parentElement.getBoundingClientRect();
    return (positionInfo.width);
  },
  autoWrapRow: true,
  height: function () {
    var positionInfo = parentElement.getBoundingClientRect();
    return (positionInfo.height / 2);
  },
  //maxRows: 22,
  contextMenu: true,
  rowHeaders: true,
...
/** @type {Element} */
var hot3Element = document.getElementById('hot3');
